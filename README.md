...
> docker run -it -d -v /home/manuel/mgallegoa/:/home/manuel/mgallegoa/ -p 3000:8081 --name manuel-dev-container manuelarias/dev-container:v1 bash -c '  while sleep 1 & wait $!; do :; done '
